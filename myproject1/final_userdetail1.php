			...
			if(strlen($name))
				{
					...
					if(in_array($ext,$valid_formats))
					{
							...
							if(move_uploaded_file($tmp, $path.$actual_image_name))
								...
								mysql_query("update mydata1 set emailpic='$actual_image_name' where email='$z'");
								mysql_query("update comment set emailidpic='$actual_image_name' where emailid='$z'");
								mysql_query("update like_insert set emailpic='$actual_image_name' where email='$z'");
								mysql_query("update book set emailpic='$actual_image_name' where email='$z'");
								mysql_query("update bikes set emailpic='$actual_image_name' where email='$z'");
								mysql_query("update accessories set emailpic='$actual_image_name' where email='$z'");
								mysql_query("update importantmessage set emailpic='$actual_image_name' where email='$z'");
