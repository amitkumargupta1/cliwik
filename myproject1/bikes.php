...
<tr><td align="left"><div align="left"><h3>post your add for selling bikes</h3></div></td></tr>
<tr>
...
/*$z=$_SESSION['y'];*/
include('config.php');
$livecomment_query20= mysql_query("select * from bikes order by id desc limit 1");
$liveupdate20=mysql_fetch_array($livecomment_query20);
$update_query20=$liveupdate20['id'];
mysql_query("UPDATE comment_live SET bikes='$update_query20' WHERE email='$z'");
...
$sql = mysql_query("select * from bikes order by id desc");
