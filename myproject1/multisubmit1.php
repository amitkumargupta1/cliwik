...
$("#unlike_post"+id).append("you unliked");
element.hide();
$.ajax({
type: "POST",
...
<textarea cols="30" rows="2" style="width:480px;font-size:14px; font-weight:bold" name="content" id="content" placeholder="update status or write any youtube link" >
</textarea><br />
...
<tr><td>State:</td><td><?php echo $user_state; ?></td></tr>
...
$sql = mysql_query("select * from mydata1 order by id desc limit 2");
...
$dbcomment1=$m['pic_comment'];
	...
	if($picname1!='')
	{
	if($dbcomment1=="updated profile pic")
...
<div class="timeline" id="updates"></div>
