...
$title=$_POST['title'];
$cost=$_POST['cost'];
mysql_query("insert into accessories value('','$email','$emailpic','$date','$time','$title','$cost','$wall_comment')");
$query2=mysql_query("select * from accessories where discription='$wall_comment' && date='$date' && time='$time' && email='$email'");
...
mysql_query("UPDATE comment_live set accessories='$msg_id' where email='$email'");
?>
<html>
<body>
