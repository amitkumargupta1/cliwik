...
<?php
 ...
 <br><br><br><br>
<div align="center">
<a href="accessories.php">sell accessories</a><br>
...
<tr><td align="left"><div align="left"><h3>post your add for selling book</h3></div></td></tr>
<tr>
<td style="padding:4px; padding-left:10px;" class="comment_box">
<textarea cols="30" rows="2"  style="width:480px;font-size:14px; font-weight:bold" name="title" id="title" placeholder="enter title" required>
</textarea><br />
<textarea cols="30" rows="2"  style="width:480px;font-size:14px; font-weight:bold" name="cost" id="cost" placeholder="enter cost" required>
</textarea><br />
