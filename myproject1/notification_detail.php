...
<?php
include('config.php');
$q=mysql_query("select ownid from notification2 order by ownid desc limit 1;");
$fetch=mysql_fetch_array($q);
for($c=1;$c<=$fetch['ownid'];$c++)
{
if(isset($_POST[$c]))
{
$q=mysql_query("select mydataid from notification2 where ownid='$c'");
$fetch=mysql_fetch_array($q);
$z1= $fetch['mydataid'];
break;
}
...
$sql = mysql_query("select * from mydata1 where id='$z1'");
