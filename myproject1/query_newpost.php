...
mysql_query("insert into querydata value('$email','','$date','$time','$emailpic','','$wall_comment','','$name')");
$query2=mysql_query("select * from querydata where wall_comment='$wall_comment' && date='$date' && time='$time' && email='$email'");
...
mysql_query("UPDATE comment_live set wall='$msg_id' where email='$email'");
...
<tr><td>
<div class="stbody"> 
<div class="stimg"><form method="post" action="query_profile1.php"><input type="hidden" name="<?php echo $msg_id; ?>">
...
<br><h1><?php echo $link_txt; ?></h1><br><div id="like_search<?php echo $msg_id; ?>"></div>
<div id="unlike_post<?php echo $msg_id; ?>"></div>
<div id="like_post<?php echo $msg_id; ?>" class="view_like" name="<?php echo $msg_id;?>"></div>
<button class="click_unlike" id="<?php echo $msg_id;?>">unsupport</button><button class="click_like" id="<?php echo $msg_id;?> ">support</button>
