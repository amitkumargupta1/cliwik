...
$title=$_POST['title'];
$cost=$_POST['cost'];
mysql_query("insert into bikes value('','$email','$emailpic','$date','$time','$title','$cost','$wall_comment')");
$query2=mysql_query("select * from bikes where discription='$wall_comment' && date='$date' && time='$time' && email='$email'");
...
mysql_query("UPDATE comment_live set bikes='$msg_id' where email='$email'");
?>
<html>
<body>
